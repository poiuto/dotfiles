...
if [ -f "/etc/arch-release" ]; then
  ...
  echo "=========================== xorg ==========================="
  sudo pacman -Sy --noconfirm xorg xorg-server xorg-xinit xorg-xprop xorg-blacklight xorg-xwininfo xf86-video-intel slock 
  ...
  #echo "=========================== xfce ==========================="
  #sudo pacman -Sy --noconfirm xorg xorg-apps xorg-server xorg-xinit
